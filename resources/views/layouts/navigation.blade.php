...
<nav x-data="{ open: false }" class="bg-main-light border-b border-main-dark">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open"
                    class="inline-flex items-center justify-center p-2 rounded-md text-main-emphasis/70 hover:text-main-emphasis hover:bg-main-dark focus:outline-none focus:bg-main-dark focus:text-main-emphasis transition duration-150 ease-in-out">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-main-dark">
            @auth
                <div class="px-4">
                    <div class="text-main-emphasis/70">{{ Str::ucfirst(Auth::user()->name) }}</div>
                    <div class="text-main-contrast/70">{{ Auth::user()->email }}</div>
                </div>
