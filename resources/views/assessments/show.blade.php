            ...
            <div class="bg-main text-main-contrast overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <div class="mt-12">
                    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        <h3 class="text-xl font-bold opacity-60">Cronologia Valutazioni</h3>
                    ...
                    @if ($viewMode === 'card')
                        <div class="grid grid-cols-1 lg:grid-cols-2 2xl:grid-cols-3 gap-6">
                            @foreach ($assessments as $assessment)
                                <x-card>
                                    <h3 class="text-lg font-bold italic">{{ $taxon['scientific_name'] }}</h3>
                                    ...
                                    <div class="space-y-1 text-sm text-gray-400">
                                        <p><strong>Anno:</strong> {{ $assessment['year_published'] }}</p>
                                        <p><strong>Possibile Estinto:</strong>
                                            {{ $assessment['possibly_extinct'] ? 'Sì' : 'No' }}</p>
                                    ...
                                    <div class="mt-4 pt-4 border-t border-main-emphasis flex justify-between">
                                        ...
                                        <x-link :href="$assessment['url']" target="_blank"
                                            ...
                                            Scheda Ufficiale<i
                                                class="ms-1 text-xs fa-solid fa-up-right-from-square"></i>
                                        </x-link>
                                    </div>
                                </x-card>
                            @endforeach
