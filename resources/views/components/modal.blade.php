...
<div x-data="{
    ...
    <div x-show="show" class="fixed inset-0 transform transition-all" x-on:click="show = false"
        ...
        <div class="absolute inset-0 bg-main-dark opacity-75"></div>
    </div>

    <div x-show="show"
        class="mb-6 bg-main-light rounded-lg overflow-hidden shadow-xl transform transition-all sm:w-full {{ $maxWidth }} sm:mx-auto"
